...
.bg {
  ...
  background-image: linear-gradient(-60deg, #556088 50%, #09f 50%);
  bottom:0;
  left:-50%;
  opacity:.5;
  position:fixed;
...
<body class="hold-transition login-page" style="background-image: linear-gradient( 135deg, #52E5E7 10%, #130CB7 100%);">
<div class="content">
  <img src="./assets/uploads/logo_dagit.png" alt="logo dagit" width="70">
